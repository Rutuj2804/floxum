...
const Footer = () => {
    ...
    <footer className="page-footer font-small  pt-4" style={{ boxShadow: "0 -2px 12px rgba(0,0,0,0.2)" }}>
                ...
                <div className="row ">
                    ...
                    <hr className="clearfix w-100 d-md-none pb-3" />
                        ...
                        <div className="col-md-2 mb-md-0 mb-3 footeredit" style={{ lineHeight: "40px" }}>
                            ...
                            <h5 style={{ fontWeight: "1000" , fontSize: "18px" }}>Catergories</h5>
                        ...
                        <div className="col-md-2 mb-md-0 mb-3 footeredit" style={{ lineHeight: "40px" }}>
                            ...
                            <h5 style={{ fontWeight: "1000" ,  fontSize: "18px"  }}>Support</h5>
                            <ul className="list-unstyled">
                                <li>
                        ...
                        <div class="col-md-2 mb-md-0 mb-3 footeredit" style={{ lineHeight: "40px" }} >

                            <h5 style={{ fontWeight: "1000" ,  fontSize: "18px" }}>Community</h5>
                            <ul className="list-unstyled">
                                <li>
                        ...
                        <div className="col-md-6 mt-md-0 mt-3" style={{ background: "#ffbb33", padding: "180px 50px", lineHeight: "40px", letterSpacing: "1px" }}>
            ...
            <div className="footer-copyright text-center py-3 " style={{ margin: "10px 0" }}>© 2020 Copyright:
        <a href="" style={{color: "#007bff"}}> ourwebiste.com. </a> All rights reserved.
    </div>
        </footer>
